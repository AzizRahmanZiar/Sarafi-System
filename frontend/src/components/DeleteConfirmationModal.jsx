...
export default function DeleteConfirmationModal({ 
    ...
    return (
        ...
        >
            <div 
                ref={modalRef}
                className={`bg-white rounded-lg shadow-xl max-w-md w-full animate-fadeIn ${isRtl ? 'rtl' : ''}`}
            >
                {/* Header */}
                ...
                {/* Footer */}
                <div className={`flex justify-end gap-3 p-4 border-t border-gray-200 bg-gray-50 rounded-b-lg ${isRtl ? 'flex-row-reverse' : ''}`}>
                    <button
                        onClick={onClose}
